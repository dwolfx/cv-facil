...
const PlanWidget = ({ current = 1, max = 2 }) => {
    return (
        <Link to="/upgrade" className="hidden md:flex items-center gap-3 bg-orange-50 dark:bg-orange-900/20 px-4 py-2 rounded-full border border-orange-100 dark:border-orange-800 cursor-pointer hover:bg-orange-100 dark:hover:bg-orange-900/40 transition-colors">
